...
const Media = () => {
    ...
    return (
        <div className={styles.blockMedias}>
              ...
              <a href="/mon-site/MB_CV.pdf" target="_blank" rel="noopener noreferrer" ref={medias4Ref} className={styles.bulle} data-tooltip-id="my-tooltip" data-tooltip-content="CV" data-tooltip-place="left">
