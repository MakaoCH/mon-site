    ...
    return (
        <div id="about" className={styles.about}>
            ...
            <p className={styles.text}>
                Bonjour ! Je suis Mickaël, développeur front-end. Après 15 ans d'expérience en tant que paramétreur d'ERP, j'ai décidé de me reconvertir au métier de développeur web.<br /><br /> 
